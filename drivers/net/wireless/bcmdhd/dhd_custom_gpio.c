...
/* Table should be filled out based on custom platform regulatory requirement */
	...
	{"GL", "US", 996},	/* Universal if Country code is GREENLAND */
	...
	{"EG", "EG", 212},
	{"ER", "ER", 0},
	/* EU/EEA remapped E0 -> US rev 996: the E0 CLM allows 5GHz STA but refuses
	 * 5GHz AP, so SoftAP beacon bring-up fails; US permits UNII-1/UNII-3 AP. */
	{"ES", "US", 996},
	{"ET", "ET", 2},
	{"FI", "US", 996},
	{"FJ", "XT", 54},
