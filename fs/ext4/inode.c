...
static int ext4_readpage(struct file *file, struct page *page)
{
	...
	if (ret == -EAGAIN)
		/* Use the encryption-aware reader so ext4_decrypt runs on
		 * completion; generic mpage_readpage never decrypts and
		 * returns ciphertext for encrypted files (upstream f64e02fe9a07). */
